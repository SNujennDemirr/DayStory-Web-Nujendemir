...
**React Router DOM:** Uygulama içi sayfa yönlendirmeleri ve navigasyon yönetimi

**Material-UI (MUI):** Modern ve tutarlı kullanıcı arayüzü bileşenleri sağlama

**Axios:** Harici API ve backend servisleri ile yapılan HTTP isteklerinin yönetimi
